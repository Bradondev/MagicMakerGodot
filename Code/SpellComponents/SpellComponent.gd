...
@export_enum("Size","Amount","Element","Damage","OnHitEffect","SpawnArea","CastType","TypeOfSpell","Movement","CastTime") var TypeOfSpellProperty: String

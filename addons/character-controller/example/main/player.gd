...
func _physics_process(delta):
	...
	if is_valid_input:
		...
		var input_crouch = Input.is_action_pressed("move_crouch")
		var input_sprint = Input.is_action_pressed("move_sprint")
		var input_swim_down = Input.is_action_pressed("move_crouch")
		var input_swim_up = Input.is_action_pressed("move_jump")
